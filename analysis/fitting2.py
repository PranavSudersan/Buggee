...
from source.analysis.plot2widget import Plot2Widget
...
##        super(QWidget, self).__init__(*args, **kwargs)
    ...
    def home(self):
        ...
        self.plotWidget = Plot2Widget(self.fig, self.plotxdata,
        ...
        layout.addWidget(plotGroupBox, 0, 1, 1, 1)
    ...
    def fitData(self, update_slice = True):
        ...
        if self.enableFitting.isChecked() == True:
            ...
            try:
                ...
                fit_ydata = self.func(self.xdata[self.fit_slice], *popt)
