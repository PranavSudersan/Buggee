...
class MainWindow(QMainWindow, Effects, MainPlaybackFunctions, MainImportFile): #also try inherit Effect, unify self.frame everywhere
    def __init__(self):
        super().__init__()
